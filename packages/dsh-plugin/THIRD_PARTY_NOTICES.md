...
| DuckDB | `duckdb>=1.5` | MIT | [duckdb/duckdb](https://github.com/duckdb/duckdb) |
| ClickHouse Connect | `clickhouse-connect>=1.7` | Apache-2.0 | [ClickHouse/clickhouse-connect](https://github.com/ClickHouse/clickhouse-connect) |
