...
const copy = {
  "en-US": {
    ...
    title: "Cubes",
    pageDescription: "Define governed measures and dimensions over a single SemaRail model or view.",
    ...
    type: "Type",
    expressionHint: "Use a SemaRail expression, such as SUM(amount) or order_date.",
    ...
    noMeasuresWarning: "A cube without measures can be saved as a draft, but SemaRail will warn during validation.",
  ...
  "zh-CN": {
    eyebrow: "语义层",
    title: "指标立方体",
    pageDescription: "围绕单个 SemaRail 模型或视图定义受治理的度量和维度。",
    ...
    expression: "表达式",
    type: "类型",
    expressionHint: "填写 SemaRail 表达式，例如 SUM(amount) 或 order_date。",
    addMeasure: "添加度量",
    addDimension: "添加维度",
    ...
    noMeasuresWarning: "没有度量的立方体仍可保存为草稿，但 SemaRail 校验时会给出警告。",
  },
} as const;
