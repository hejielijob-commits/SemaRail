/** Pack SemaRail Core and write a SHA-256 checksum. */
...
const expected = '@hejielijob/semarail-core'
const packageDir = resolve(repository, 'packages', 'core')
...
if (manifest.name !== expected || typeof manifest.version !== 'string') {
